...
if clean_profile and os.path.exists(USER_DATA_DIR):
    #print("🧹 Clearing old browser profile...")
...
with sync_playwright() as p:
    ...
    # 🔥 CORRECT locator for your version
    ...
    for i in range(count):
        ...
        # Extract index from data-testid
        test_id = input_box.get_attribute("data-testid")
        # Example: recovery-phrase-input-2
        position = int(test_id.split("-")[-1])  # zero-based index
